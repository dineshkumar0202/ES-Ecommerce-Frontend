...
export declare class Predictions extends APIResource {
     ...
     * ```
     */
    subscribe(body: PredictionSubscribeParams, options?: RequestOptions): Promise<PredictionSubscribeResponse>;
...
export declare namespace PredictionStatusResponse {
    /**
     * Structured error object with name and message fields
     */
    interface Error {
         ...
         */
        name: 'ImageLoadError' | 'ContentModerationError' | 'PoseError' | 'LoRALoadError' | 'InputValidationError' | 'PipelineError' | 'ThirdPartyError' | '3rdPartyProviderError' | 'InternalServerError' | 'PollingTimeout';
    }
}
export type PredictionRunParams = PredictionRunParams.TryOnRequest | PredictionRunParams.ProductToModelRequest | PredictionRunParams.FaceToModelRequest | PredictionRunParams.ModelCreateRequest | PredictionRunParams.ModelVariationRequest | PredictionRunParams.ModelSwapRequest | PredictionRunParams.ReframeRequest | PredictionRunParams.BackgroundChangeRequest | PredictionRunParams.BackgroundRemoveRequest | PredictionRunParams.ImageToVideoRequest;
export declare namespace PredictionRunParams {
    ...
    namespace ProductToModelRequest {
        interface Inputs {
            /**
    ...
    interface ModelVariationRequest {
        /**
         * Body param:
         */
    ...
    namespace ModelVariationRequest {
        interface Inputs {
            /**
    ...
    interface BackgroundChangeRequest {
        /**
         * Body param:
         */
    ...
    namespace BackgroundChangeRequest {
        interface Inputs {
            /**
    ...
    namespace BackgroundRemoveRequest {
        interface Inputs {
            /**
...
export declare namespace Predictions {
    export { type PredictionRunResponse as PredictionRunResponse, type PredictionStatusResponse as PredictionStatusResponse, type PredictionRunParams as PredictionRunParams, type PredictionSubscribeParams as PredictionSubscribeParams, type PredictionSubscribeResponse as PredictionSubscribeResponse, };
}
