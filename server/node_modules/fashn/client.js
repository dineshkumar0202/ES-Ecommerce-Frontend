...
var _Fashn_instances, _a, _Fashn_encoder, _Fashn_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Fashn = void 0;
...
const predictions_1 = require("./resources/predictions.js");
...
class Fashn {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('FASHN_BASE_URL'), apiKey = (0, env_1.readEnv)('FASHN_API_KEY'), ...opts } = {}) {
        _Fashn_instances.add(this);
        _Fashn_encoder.set(this, void 0);
        this.predictions = new API.Predictions(this);
        if (apiKey === undefined) {
            throw new Errors.FashnError("The FASHN_API_KEY environment variable is missing or empty; either provide it, or instantiate the Fashn client with an apiKey option, like new Fashn({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
            baseURL: baseURL || `https://api.fashn.ai`,
        };
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('FASHN_LOG'), "process.env['FASHN_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 3;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Fashn_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.FashnError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Fashn_instances, "m", _Fashn_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    calculateDefaultRetryTimeoutMillis(retriesRemaining, maxRetries) {
        const initialRetryDelay = 2.0;
        const maxRetryDelay = 6.0;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Fashn_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Fashn = Fashn;
_a = Fashn, _Fashn_encoder = new WeakMap(), _Fashn_instances = new WeakSet(), _Fashn_baseURLOverridden = function _Fashn_baseURLOverridden() {
    return this.baseURL !== 'https://api.fashn.ai';
};
Fashn.Fashn = _a;
Fashn.DEFAULT_TIMEOUT = 60000; // 1 minute
Fashn.FashnError = Errors.FashnError;
Fashn.APIError = Errors.APIError;
Fashn.APIConnectionError = Errors.APIConnectionError;
Fashn.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Fashn.APIUserAbortError = Errors.APIUserAbortError;
Fashn.NotFoundError = Errors.NotFoundError;
Fashn.ConflictError = Errors.ConflictError;
Fashn.RateLimitError = Errors.RateLimitError;
Fashn.BadRequestError = Errors.BadRequestError;
Fashn.AuthenticationError = Errors.AuthenticationError;
Fashn.InternalServerError = Errors.InternalServerError;
Fashn.PermissionDeniedError = Errors.PermissionDeniedError;
Fashn.UnprocessableEntityError = Errors.UnprocessableEntityError;
Fashn.toFile = Uploads.toFile;
Fashn.Predictions = predictions_1.Predictions;
