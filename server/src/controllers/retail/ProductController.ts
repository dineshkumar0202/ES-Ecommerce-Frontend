...
class ProductController {
    ...
    async updateProduct(req: IAuthRequest, res: Response) {
        try {
            const updatedProduct = await ProductService.updateProduct(req.params.id as string, req.user._id as string, req.body);
            if (updatedProduct) {
    ...
    async deleteProduct(req: IAuthRequest, res: Response) {
        try {
            const success = await ProductService.deleteProduct(req.params.id as string, req.user._id as string);
            if (success) {
