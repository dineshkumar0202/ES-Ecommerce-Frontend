...
const TShirts = () => {
    ...
    // Show 20 NEW Fashion Products (IDs 41-60)
    // Includes: Jeans, Jackets, Hoodies, Suits, Polo Shirts, Dresses, Skirts, Boots, Sneakers, Accessories
    const fashionProductIds = Array.from({ length: 20 }, (_, i) => 41 + i); // 41 to 60

    const displayProducts = allProducts.filter(p => fashionProductIds.includes(p.id));
